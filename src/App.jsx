...
function App() {
  return (
    <section id="form" className="isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div className="mx-auto max-w-2xl text-center">
        <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl" style={{ fontFamily: 'pirulen' }} >CCL Cohort 4 Graduation RSVP</h2>
        <p className="text-lg leading-8 text-gray-600">June 22, 2023</p>
        <p className="text-lg leading-8 text-gray-600">780 Mt Vernon Ave, Columbus, OH 43203</p>
      </div>
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        ...
        <div className="mt-10">
          <button type="submit" className="block w-full rounded-md bg-blue-700 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
            Submit
          </button>
        </div>
      </form>
